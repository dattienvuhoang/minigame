...
namespace VuTienDat
{
    public class UIController_Level_28 : MonoBehaviour
    {
        ...
        public static UIController_Level_28 instance;
        private void Awake()
        {
            instance = this;
        }
        ...
        private void Start()
        {
            ...
            btnHint.onClick.AddListener(DragController_Level_28.ins.OpenHint);*/
        }
        private void Update()
        {
        ...
        {
            time = GameManager_Level_28.instance.getTime();
        }
