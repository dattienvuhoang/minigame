...
namespace VuTienDat
{
    public class UIController_level_1_2 : MonoBehaviour
    {
        ...
        public static UIController_level_1_2 instance;
        private void Awake()
        {
            instance = this;
        }
        ...
        private void Start()
        {
            ...
            btnHint.onClick.AddListener(DragController_Level_1_2.ins.OpenHint);*/
        }
        private void Update()
        {
        ...
        {
            time = GameManager_level_1_2.instance.getTime();
        }
