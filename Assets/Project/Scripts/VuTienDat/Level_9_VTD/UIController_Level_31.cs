...
namespace VuTienDat
{
    public class UIController_Level_31 : MonoBehaviour
    {
        ...
        public static UIController_Level_31 instance;
        private void Awake()
        {
            instance = this;
        }
        ...
        private void Start()
        {
           ...
           /* btnBack.onClick.AddListener(BackLevel);
            ...
            btnHint.onClick.AddListener(DragController_Level_31.instance.OpenHint);*/
        }
        private void Update()
        {
        ...
        {
            time = GameManager_Level_31.instance.getTime();
        }
