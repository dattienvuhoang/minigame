...
namespace VuTienDat
{
    public class UIController_Level_10 : MonoBehaviour
    {
        ...
        public static UIController_Level_10 instance;
        private void Awake()
        {
            instance = this;
        }
        ...
        private void Start()
        {
            ...
            btnHint.onClick.AddListener(DragController_Level_10.ins.OpenHint);*/
        }
        private void Update()
        {
        ...
        {
            time = GameManager_Level_10.instance.getTime();
        }
