...
namespace VuTienDat
{
    public class UIController_Level_7 : MonoBehaviour
    {
        ...
        public static UIController_Level_7 instance;
        private void Awake()
        {
            instance = this;
        }
        ...
        private void Start()
        {
           ...
           /* btnBack.onClick.AddListener(BackLevel);
            ...
            btnHint.onClick.AddListener(DragController_Level_7.ins.OpenHint);*/
        }
        private void Update()
        {
        ...
        {
            time = GameManager_Level_7.instance.getTime();
        }
