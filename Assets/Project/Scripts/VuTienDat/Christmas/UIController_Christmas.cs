...
namespace VuTienDat
{
    public class UIController_Christmas : MonoBehaviour
    {
        ...
        public static UIController_Christmas instance;
        private void Awake()
        {
            if (instance == null)
            {
        ...
        {
            time = GameManager_Christmas.instance.getTime();
        }
        public void AddButton()
        {
            ...
            btnHint.onClick.AddListener(DragController_Christmas.instance.OpenHint);
        }
    }
}
