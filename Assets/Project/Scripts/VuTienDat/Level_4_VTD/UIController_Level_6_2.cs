...
namespace VuTienDat
{
    public class UIController_Level_6_2 : MonoBehaviour
    {
        ...
        public static UIController_Level_6_2 instance;
        private void Awake()
        {
            instance = this;
        }
        ...
        private void Start()
        {
           ...
           /* btnBack.onClick.AddListener(BackLevel);
            ...
            btnHint.onClick.AddListener(DragController_Level_6_2.ins.OpenHint);*/
        }
        private void Update()
        {
        ...
        {
            time = GameManager_Level_6_2.instance.getTime();
        }
