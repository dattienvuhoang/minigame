...
namespace VuTienDat
{
    public class UIController_Level_7_2 : MonoBehaviour
    {
        ...
        public static UIController_Level_7_2 instance;
        private void Awake()
        {
            instance = this;
        }
...
/*
            ...
            btnHint.onClick.AddListener(DragController_7_2.instance.OpenHint);*/
        }
        private void Update()
        {
        ...
        {
            time = GameManager_Level_7_2.instance.getTime();
        }
