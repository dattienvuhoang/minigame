...
namespace VuTienDat
{
    public class UIController_Level_40 : MonoBehaviour
    {
        ...
        public static UIController_Level_40 instance;
        private void Awake()
        {
            if (instance == null)
            {
        ...
        private void Start()
        {
           ...
           /* btnBack.onClick.AddListener(BackLevel);
            ...
            btnHint.onClick.AddListener(DragController_Level_40.ins.OpenHint);*/
        }
        private void Update()
        {
        ...
        {
            time = GameManager_Level_40.instance.getTime();
        }
