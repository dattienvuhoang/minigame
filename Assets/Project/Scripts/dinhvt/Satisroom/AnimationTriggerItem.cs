...
namespace dinhvt
{
    public class AnimationTriggerItem : Item
    {
        [Space(20)]
        ...
        public override void Deselect(Vector3 touchPosition)
        {
            ...
            if (hitInfo && canComplete)
            {
                ...
                {
                    //transform.DOMove(hitTransform.position, 0.2f).OnComplete(() =>
                    //{
                    //    StartCoroutine(PlayAnimAndComplete());
                    //});

                    transform.DOMove(startAnimHolder.position, 0.2f).OnComplete(() =>
                    {
                        ...
                        DOVirtual.DelayedCall(clip.length, () =>
                        {
                            ...
                            transform.DOMove(_initialPosition, moveTime).OnComplete(CompleteMission);
                        });
                    });
        ...
        //IEnumerator PlayAnimAndComplete()
        //{
        //    animator.Play(clip.name, 0, 0f);
